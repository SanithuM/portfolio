  ...
  return (
    <>
      <div className="relative overflow-x-clip">
        ...
        <div className="absolute -z-20 left-8 bottom-20 w-60 h-60 rounded-full opacity-18 blur-3xl bg-gradient-to-br from-lime-200 via-emerald-200 to-teal-200 bg-blob-animation-slow"></div>
        <div className="absolute -z-20 right-16 top-40 w-44 h-44 rounded-full opacity-16 blur-3xl bg-gradient-to-br from-cyan-100 via-sky-200 to-indigo-200 bg-blob-animation-slower"></div>
